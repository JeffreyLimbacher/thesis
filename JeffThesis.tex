...
As we can see from the table, the the fourier method still outperforms the direct method in time. However, the speed up drops dramatically as more zeros are added with the $N=21$ case having the speed up get halved by adding one zero. to the calculation, showing a severe cost for the dramatic increase in accuracy. 
